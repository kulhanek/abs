...
class CCollectionOptions : public CSimpleOptions {
 ...
 // program name and description -----------------------------------------------
    ...
    CSO_PROG_ARGS_LONG_DESC_BEGIN
        "<b>Actions:</b>\n"
        "   <b><cyan>info</cyan></b>\n"
        "          list jobs in collection (default action)\n\n"
        "   <b><cyan>create</cyan></b>\n"
        "          create new collection <u>collname</u>\n\n"
        "   <b><cyan>open</cyan></b>\n"
        "          open existing collection <u>collname</u> if collection does not exist it is created\n\n"
        "   <b><cyan>close</cyan></b>\n"
        "          close <u>collname</u> collection\n\n"
        "   <b><cyan>prepare</cyan></b> destination job [resources] [syncmode]\n"
        "          add all <u>job</u> to <u>collname</u> collection\n\n"
        "   <b><cyan>submit</cyan></b>\n"
        "          submit all jobs in the collection <u>collname</u>\n"
        "   <b><cyan>kill</cyan></b>\n"
        "          kill all jobs in the collection <u>collname</u>\n"
