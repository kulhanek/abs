...
bool CPBSProServer::SubmitJob(CJob& job,bool verbose)
{
    ...
    variables << ",INF_COLLECTION_NAME=" << job.GetItem("basic/collection","INF_COLLECTION_NAME",false);
    variables << ",INF_COLLECTION_PATH=" << job.GetItem("basic/collection","INF_COLLECTION_PATH",false);
    variables << ",INF_COLLECTION_ID=" << job.GetItem("basic/collection","INF_COLLECTION_ID",false);
